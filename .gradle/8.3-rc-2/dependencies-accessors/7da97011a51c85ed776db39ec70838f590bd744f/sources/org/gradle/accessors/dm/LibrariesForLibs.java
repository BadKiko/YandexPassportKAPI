...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SealedxLibraryAccessors laccForSealedxLibraryAccessors = new SealedxLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at sealedx
     */
    public SealedxLibraryAccessors getSealedx() {
        return laccForSealedxLibraryAccessors;
    }
    ...
    public static class SealedxLibraryAccessors extends SubDependencyFactory {

        public SealedxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for core (com.github.skydoves:sealedx-core)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
                return create("sealedx.core");
        }

            /**
             * Creates a dependency provider for processor (com.github.skydoves:sealedx-processor)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getProcessor() {
                return create("sealedx.processor");
        }
    ...
    public static class SkydovesLibraryAccessors extends SubDependencyFactory {
        ...
        public SkydovesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getSandwich() {
                return create("skydoves.sandwich");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final SealedxVersionAccessors vaccForSealedxVersionAccessors = new SealedxVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.sealedx
         */
        public SealedxVersionAccessors getSealedx() {
            return vaccForSealedxVersionAccessors;
        }
    ...
    public static class GithubVersionAccessors extends VersionFactory  {
        ...
        public GithubVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: github.sandwich (1.3.9)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSandwich() { return getVersion("github.sandwich"); }
    ...
    public static class SealedxVersionAccessors extends VersionFactory  {

        public SealedxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: sealedx.core (1.0.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCore() { return getVersion("sealedx.core"); }
